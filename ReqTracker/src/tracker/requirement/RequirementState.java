...
/**
 * Interface for states in the Requirement State Pattern. All concrete
 * requirement states must implement the RequirementState interface.
 * 
...
public interface RequirementState
{
	...
	/**
	 * Update the {@link Requirement} based on the given {@link Command}. An
